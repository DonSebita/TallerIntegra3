...
import BotonLogin from "@/components/botones/BotonLogin";
...
export default function Login() {
  ...
  return (
    <View style={[styles.container, Platform.OS === 'web' && styles.webContainer]}>
        <Text style={styles.title}>AGENDA VIRTUAL</Text>
        <Image 
          source="../assets/images/temuco.png"
          contentFit="cover"
          style={styles.logo} 
        />
      ...
      <EntradaDatos
        ...
        style={styles.input}
      />
      <BotonLogin text="Ingresar" onPress={sePresiono} />
